...
import { deleteLesson, getLessons } from "../services/lessonsApi";
  ...
  return (
    <section className="space-y-6">
      <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">
            Manage course lessons, preview status, publishing, and video
            connection.
          </p>
        </div>
        ...
        <Link
          to={
            courseId
              ? `/admin/lessons/create?course=${courseId}`
      ...
      {loading ? (
        ...
        <LessonsTable lessons={filteredLessons} onDelete={setSelectedLesson} />
      )}
